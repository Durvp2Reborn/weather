...
export function useLocation(searchTerm: string) {
    ...
    useEffect(()=> {
        ...
        fetch(`https://api.geoapify.com/v1/geocode/search?text=${searchTerm}&lang=en&limit=1&type=city&filter=countrycode:us&format=json&apiKey=b8568cb9afc64fad861a69edbddb2658`)
            .then((res) => res.json())
            .then((data) => {
